...
**AGENT_WORKFLOW.md(セッションの始め方・エージェント運用規約・Codex委譲の型・
...
新しいセッションを始めるとき、およびCodexへの委譲を行うときは、必ず
**[docs/AGENT_WORKFLOW.md](docs/AGENT_WORKFLOW.md)** のセッション開始チェックリストと
エージェント運用規約に従うこと。要点だけ書くと:
